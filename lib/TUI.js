...
console.log(util.inspect(colorIndex, {colors: true}));

console.log(util.inspect(hexToLab(0xffffff), {colors: true}));
console.log(util.inspect(rgbToLab(255, 255, 255), {colors: true}));
